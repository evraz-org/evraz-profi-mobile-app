...
class ActivityScanResultPaySuccess : BtsppActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityScanResultPaySuccessBinding.inflate(layoutInflater)
        //  设置自动布局
        ...
        //  UI - 支付金额、收款人、交易ID
        binding.tvPayAmountFromScanResultPaySuccess.text = args.optString("amount_string")
        binding.tvReceiverAccountFromScanResultPaySuccess.text = to_account.getString("name")
        binding.tvTransactionIdFromScanResultPaySuccess.text = trx_id
