...
class ActivityPermissionAddOne : BtsppActivity() {
    ...
    private lateinit var _binding: ActivityPermissionAddOneBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _binding = ActivityPermissionAddOneBinding.inflate(layoutInflater)
        ...
        _binding.layoutBackFromAddOnePermission.setOnClickListener {
            finish()
        }
        ...
        _binding.btnSearch.setOnClickListener {
            TempManager.sharedTempManager().set_query_account_callback { last_activity, it ->
                ...
                val tf = _binding.tfAuthorityName
        ...
        //  提交按钮
        _binding.btnSubmittFromAddOnePermission.setOnClickListener {
            _onSubmitClicked()
        }
    }

    private fun _onSubmitClicked() {
        val str_authority = _binding.tfAuthorityName.text.toString().trim()
        val str_weight = _binding.tfWeight.text.toString().trim()
