...
class ActivityOtcMcHome : BtsppActivity() {
    ...
    private lateinit var _binding: ActivityOtcMcHomeBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        _binding = ActivityOtcMcHomeBinding.inflate(layoutInflater)
        // 设置自动布局
        ...
        _binding.imgIconOtcMcAsset.setColorFilter(iconcolor)
        _binding.imgIconOtcMcAd.setColorFilter(iconcolor)
        _binding.imgIconOtcMcOrder.setColorFilter(iconcolor)
        _binding.imgIconOtcMcPayment.setColorFilter(iconcolor)
        _binding.imgIconOtcMcReceive.setColorFilter(iconcolor)

        val nickname = merchant_detail.getString("nickname")
        _binding.tvMcFirstNameFromOtcMcHome.text = nickname.substring(0, 1)
        _binding.tvMcFirstNameFromOtcMcHome.background = getDrawable(R.drawable.circle_character_view)

        //  TODO:2.9 status
        _binding.tvMcNameFromOtcMcHome.text = nickname
        _binding.tvAuthTextFromOtcMcHome.text = "已认证"
        _binding.tvDateFromOtcMcHome.text = OtcManager.fmtMerchantTime(merchant_detail.getString("ctime"))

        //  基本信息
        _binding.layoutOtcMerchantHomeBasic.setOnClickListener {
        ...
        //  商家资产
        _binding.layoutAssetListFromOtcMcHome.setOnClickListener {
            OtcManager.sharedOtcManager().guardUserIdVerified(this, null) { auth_info, _ ->
        ...
        //  商家广告
        _binding.layoutAdListFromOtcMcHome.setOnClickListener {
            OtcManager.sharedOtcManager().guardUserIdVerified(this, null) { auth_info, _ ->
                //  TODO:3.0 激活代码临时放在这里
        ...
        //  商家订单
        _binding.layoutOrderListFromOtcMcHome.setOnClickListener {
            OtcManager.sharedOtcManager().guardUserIdVerified(this, null) { auth_info, _ ->
        ...
        //  收款方式
        _binding.layoutReceiveMethodsFromOtcMcHome.setOnClickListener {
            OtcManager.sharedOtcManager().guardUserIdVerified(this, null) { auth_info, _ ->
        ...
        //  付款方式
        _binding.layoutPaymentMethodsFromOtcMcHome.setOnClickListener {
            OtcManager.sharedOtcManager().guardUserIdVerified(this, null) { auth_info, _ ->
        ...
        //  返回按钮事件
        _binding.layoutBackFromOtcMcHome.setOnClickListener { finish() }
    }
